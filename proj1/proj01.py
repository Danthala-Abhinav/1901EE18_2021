...
app.config['MAIL_USERNAME'] = 'danthalaabhi@gmail.com'
app.config['MAIL_PASSWORD'] = 'Orangefire122@'
...
def send_email():
    ...
    for roll_no,email1,email2 in roll_email_list:
        msg = Message('Your marks',sender ='danthalaabhi@gmail.com',recipients = [email1,email2])
