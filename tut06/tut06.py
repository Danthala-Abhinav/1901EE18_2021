...
def breaking_bad_renamer(webseries_name,season_padding,episode_padding):
    folder1  = "corrected_srt"
    if not os.path.exists(folder1): 
        os.makedirs(folder1)
    episode_pad = int(episode_padding)
    season_pad = int(season_padding)
    basepath = "./wrong_srt"
    destiny=os.path.join(os.getcwd(),"corrected_srt",webseries_name)
    path=os.path.join(os.getcwd(),"wrong_srt",webseries_name)
    dest=os.path.join(os.getcwd(),"corrected_srt")
...
def gameofthrones_renamer(webseries_name,season_padding,episode_padding):
    folder1 = "corrected_srt"
    if not os.path.exists(folder1): 
        os.makedirs(folder1)
...
def lucifer_renamer(webseries_name,season_padding,episode_padding):
    folder1 = "corrected_srt"
    if not os.path.exists(folder1): 
        os.makedirs(folder1)
    season_pad = (season_padding)
...
def regex_renamer(): 
    ...
    print("1. Breaking Bad")		# User input
    ...
    if (webseries_num==1) :  
            breaking_bad_renamer('Breaking Bad',season_padding,episode_padding)
    elif (webseries_num==2) : 
            gameofthrones_renamer('Game of Thrones',season_padding,episode_padding)
    elif (webseries_num==3) :  
            lucifer_renamer('Lucifer',season_padding,episode_padding)
    return 
